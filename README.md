...
转换完成后，可以进入“人工校正”标签页修改标题、摘要、关键词、作者、单位、章节、图题和参考文献。点击“重新生成 XML”后，系统会基于校正后的文章数据更新 XML 与校验结果。
...
- `word2jats_feature_acceptance.docx`：覆盖当前主要功能，包含 4 张图片和 5 个图题，用于测试 caption-only figure。
